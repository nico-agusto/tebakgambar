...
public class PahamActivity extends Activity {

	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_paham);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "PAHAM LIBERAL";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.paham, menu);
		return true;
	}
