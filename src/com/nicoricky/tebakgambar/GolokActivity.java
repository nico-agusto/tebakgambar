...
public class GolokActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.golok, menu);
		return true;
	}

	public void cekJawaban(View v){
		String jawabanBenar = "GOLOK PUSAKA";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),GadisActivity.class);
			startActivity(i);
		}
		else{
