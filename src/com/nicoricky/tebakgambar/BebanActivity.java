package com.nicoricky.tebakgambar;
...
public class BebanActivity extends Activity {

	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_beban);
    ...
    public void cekJawaban(View v){
		String jawabanBenar = "BEBAN TALANGAN";
		...
		if (jawabanUser.equals(jawabanBenar)){			
			...
			Intent i = new Intent(getApplicationContext(),BauActivity.class);
			startActivity(i);
		}
		else{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.beban, menu);
		return true;
	}
